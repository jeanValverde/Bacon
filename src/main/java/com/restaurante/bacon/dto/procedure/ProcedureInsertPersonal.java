        ...
        @NamedStoredProcedureQueries(
                {
                    @NamedStoredProcedureQuery(name = "InsertPersonal", procedureName = " PACKAGE_PERSONAL.PR_INSERT_PERSONAL",
                            parameters = {
                                ...
                                @StoredProcedureParameter(mode = ParameterMode.IN, name = P_CONTRASENA_PERSONAL, type = String.class),
                                @StoredProcedureParameter(mode = ParameterMode.IN, name = P_ESTADO_PERSONAL, type = String.class)
