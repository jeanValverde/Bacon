...
function validatorForms(formulario) {
    ...
    var validar = function (e) {
        ...
        for (var i = 0, max = formulario.elements.length; i < max; i++) {
            ...
            if (formulario.elements[i].id == "rutProveedor") {
                
                if (validarVacio(formulario.elements[i])) {
                    valida_Rut(formulario.elements[i]);
                    document.getElementById("mensajeRut").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
       
                } else {
                    document.getElementById("mensajeRut").setAttribute("style", "display: block");
            ...
            if (formulario.elements[i].id == "nombreProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeNombre").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeNombre").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }

            if (formulario.elements[i].id == "direccionProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeDireccion").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeDireccion").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }

            if (formulario.elements[i].id == "telefonoProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeTelefono").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeTelefono").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }

            if (formulario.elements[i].id == "contactoProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeContacto").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeContacto").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }

            if (formulario.elements[i].id == "tipoProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeTipo").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeTipo").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }

            if (formulario.elements[i].id == "correoProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeCorreo").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeCorreo").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }

            if (formulario.elements[i].id == "celularProveedor") {
                ...
                if (validarSiNumero(formulario.elements[i])) {
                    ...
                    document.getElementById("mensajeCelular").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                    if (stock < 0) {
                        document.getElementById("mensajeCelular").setAttribute("style", "display: block");
                        formulario.elements[i].setAttribute("class", "form-control is-invalid");
                        e.preventDefault(e);
                    }
                } else {
            ...
            if (formulario.elements[i].id == "categoriaProveedor") {
                if (validarVacio(formulario.elements[i])) {
                    document.getElementById("mensajeCategoria").setAttribute("style", "display: display");
                    formulario.elements[i].setAttribute("class", "form-control is-valid");
                } else {
                    document.getElementById("mensajeCategoria").setAttribute("style", "display: block");
                    formulario.elements[i].setAttribute("class", "form-control is-invalid");
                    e.preventDefault(e);
                }
            }
